...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieW9hbGZyYWRvMjgiLCJhIjoiY2x5bmhoZno3MDZobTJscHBtd2w3dmo5MCJ9.nULRuXpn3MuGWWLq5Eiuvg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yoalfrado28/clyrsaxdm001p01qoacle1lay',
    scrollZoom: false
    // center: [-73.875807, 40.707814],
    // zoom: 10,
    // interactive: false,
  });
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Pq2e0GykZTQLEnASYRbCO8GoMcxjpI3O8MHgIsxy7i1pvLwLNa0iQ49khQ09hrBZhFI5452BWkQp084T1vQof41008CUD74EU');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup.signup)(name, email, password, confirm);
});
if (mapbox) {
